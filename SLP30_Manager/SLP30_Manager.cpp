...
// SLP30_Manager.cpp : 응용 프로그램에 대한 클래스 동작을 정의합니다.
//
...
BEGIN_MESSAGE_MAP(CSLP30_ManagerApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// CSLP30_ManagerApp 생성

CSLP30_ManagerApp::CSLP30_ManagerApp()
{
	// 다시 시작 관리자 지원
...
// 유일한 CSLP30_ManagerApp 개체입니다.

CSLP30_ManagerApp theApp;


// CSLP30_ManagerApp 초기화

BOOL CSLP30_ManagerApp::InitInstance()
{
...
int CSLP30_ManagerApp::ExitInstance()
{
