...
// CPopupDbListCtrl 뷰입니다.

class CPopupDbListCtrl : public CScrollView
{
	DECLARE_DYNCREATE(CPopupDbListCtrl)

protected:
	CPopupDbListCtrl();           // 동적 만들기에 사용되는 protected 생성자입니다.
	virtual ~CPopupDbListCtrl();
